    ...
    try:
        ...
        config = picam2.create_video_configuration(
            ...
            controls={
                ...
                # "NoiseReductionMode": controls.NoiseReductionModeEnum.Fast, # Keep commented if causes issues
                "Brightness": 0.0,
                "Contrast": 1.0,
                "Saturation": 1.0,
            }
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div id="error" {'style="display: block;"' if err_msg else ''}>{err_msg}</div> <img id="stream" src="{url_for('video_feed')}" width="{current_w}" height="{current_h}" alt="Loading stream..."
...
def main():
    ...
    if capture_thread and capture_thread.is_alive():
        ...
        # Adjust join timeout based on shutdown wait?
    ...
    # Flask thread is daemon and should exit
